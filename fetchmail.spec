%global alpha	alpha13
%global commit	4e7107365ac0d8f6d16a965aefce71711116d0ac
...
%files -f %{name}.lang
%doc COPYING NEWS README README.SSL TODO-7.0 README.OAUTH2 README.SSL-SERVER
%doc contrib/fetchmail-oauth2.py contrib/oauth2-example*
%{_bindir}/fetchmail
...
%changelog
* Sat Feb 07 2026 Udo Seidel <udoseidel@gmx.de> - 7.0.0-0.2.4e71073
- updated to latest next commit

* Mon Dec 04 2023 Udo Seidel <udoseidel@gmx.de> - 7.0.0-0.2.c898210
- updated to latest next commit
...
* Sun Oct 30 2022 Udo Seidel <udoseidel@gmx.de> - 7.0.0-0.2.4369b3c
- updated to latest next commit

* Fri Oct 28 2022 Udo Seidel <udoseidel@gmx.de> - 7.0.0-0.2.e605b34
- updated to latest next commit

* Thu Oct 27 2022 Udo Seidel <udoseidel@gmx.de> - 7.0.0-0.2.c140fc6
- updated to latest next commit
...
* Wed Oct 05 2022 Vitezslav Crhonek <vcrhonek@redhat.com> - 7.0.0-0.4.4d8943c
- Add OAuth2 related files to doc

* Thu Sep 29 2022 Vitezslav Crhonek <vcrhonek@redhat.com> - 7.0.0-0.3.4d8943c
- Use more recent upstream commit as fetchmail alpha tarballs were outdated
  and have been withdrawn. See
  https://sourceforge.net/projects/fetchmail/files/branch_7-alpha/
- Update list of documentation files

* Mon Sep 26 2022 Vitezslav Crhonek <vcrhonek@redhat.com> - 7.0.0-0.2.alpha7
